...
export const mars = [
    {
      detail: DETAILS.mass,
      title: { EN: 'index fun 1', BG: 'разстояние от mars' },
    ...
    },
    {
      ...
      title: { EN: 'index fun 2', BG: 'разстояние от mars1' },
      core: { EN: '8.14 light minutes', BG: '8.14 светлинни минути' },
      tooltip: { EN: 'additional info', BG: 'допълнителна информация'},
    },
    {
      detail: DETAILS.orbit,
      title: { EN: 'index fun 3', BG: 'разстояние от mars2' },
      core: { EN: '8.14 light minutes', BG: '8.14 светлинни минути' },
      tooltip: { EN: 'additional info', BG: 'допълнителна информация'},
    },
    {
      detail: DETAILS.satelites,
      title: { EN: 'index fun 4', BG: 'разстояние от mars3' },
      core: { EN: '8.14 light minutes', BG: '8.14 светлинни минути' },
      tooltip: { EN: 'additional info', BG: 'допълнителна информация'},
    },
  ];
